...
void main()
{
	...
	for_hr.push_back(my_company.CreateTeamleader(0, "Andrey", "Yaushev", "nomail@nomail.no", 3100));
	for_acc.push_back(my_company.CreateProgrammer(0, "Name", "Surname", "kek111@yandex.com", 2300));
